...
public record RefreshToken(string AccessToken, string Token) : ICommand<Result<AccessTokenDto>>;

public class RefreshTokenHandler : ICommandHandler<RefreshToken, Result<AccessTokenDto>>
{
    ...
    public RefreshTokenHandler(ITokenRepository tokenRepository, ITokenProvider tokenService,
    ...
    public async Task<Result<AccessTokenDto>> HandleAsync(RefreshToken command,
        CancellationToken cancellationToken = default)
    {
        ...
        var storedRefreshTokenResult = await _tokenRepository.GetToken(command.Token, cancellationToken);
